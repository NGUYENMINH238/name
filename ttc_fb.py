...
{Fore.YELLOW}╚══════════════════════════════════════════════════╝
{Fore.WHITE}════════════════════════════════════════════════════
{Fore.RED}  © COPY RIGHT BY M-H    {Fore.WHITE}Phiên Bản: {Fore.YELLOW}TTC FACEBOOK
{Fore.WHITE}════════════════════════════════════════════════════
...
def chongblock(delaybl):
	for i in range(delaybl, -1, -1):
		Write.Print(f'Đang chống block chạy lại sau {i} giây  \r',Colors.Colors.rainbow,interval=0.0001);sleep(1); print('                                                        ', end = '\r')
